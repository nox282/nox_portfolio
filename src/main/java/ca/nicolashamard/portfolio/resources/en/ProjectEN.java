...
public class ProjectEN {
	...
	public ProjectEN(String id, String title, String description, String[] controls, String note, String url, String sourceURL, String imageURL, String[] screenshots, String videoURL, Collaborator[] team, String gameEngine, String[] technologies, String[] tags){
		this.id = id;
		this.title = title;
