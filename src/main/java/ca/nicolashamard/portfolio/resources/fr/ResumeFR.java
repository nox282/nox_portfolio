...
public class ResumeFR {
	...
	public ResumeFR (String id, String firstname, String lastname, String pictureURL, String location, String[] languages, String description, Education[] education, Employment[] employment, String[] technologies, Social[] socials, String[] interestedIn) {
		this.id = id;
